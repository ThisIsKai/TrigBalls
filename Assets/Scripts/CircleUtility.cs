...
public static class CircleUtility { 																	// as a utility, it's NOT A MONOCLASS!!!
																										// means I can't add this script to anything, but OTHER SCROPTS can call/reference what's in it
	...
	public static Vector2 PointOnSphere (float radius, float horizontalAngle, float verticalAngle) {  	// PointOnSphere
